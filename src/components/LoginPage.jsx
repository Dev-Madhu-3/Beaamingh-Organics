      ...
      <div className="relative z-10 w-full max-w-md">
        <AnimatedSection animation="scale">
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            {/* Form body */}
            <div className="p-8" style={{ minHeight: '450px' }}>
              {submitSuccess ? (
                <AnimatedSection animation="scale">
                    ...
                    <div className="mb-2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-3 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition ${
                  ...
                  <div className="flex flex-col justify-between flex-grow">
                    ...
                    <AnimatedSection animation="fade-up" delay={400}>
                      <button
                        ...
                        className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-bold py-3 px-4 rounded-lg hover:from-blue-600 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-300 transform hover:scale-[1.02] disabled:opacity-70 disabled:cursor-not-allowed"
                      >
                        {isSubmitting ? (
